...
<pre><span class="s0">// Entry point for Whale Base</span>
<span class="s2">public class </span><span class="s1">Main </span><span class="s3">{</span>
    <span class="s2">public static void </span><span class="s1">main</span><span class="s3">(</span><span class="s1">String</span><span class="s3">[] </span><span class="s1">args</span><span class="s3">) {</span>
        <span class="s1">MenuUI ui </span><span class="s3">= </span><span class="s2">new </span><span class="s1">MenuUI</span><span class="s3">();</span>
        <span class="s1">ui</span><span class="s3">.</span><span class="s1">start</span><span class="s3">();</span>
    <span class="s3">}</span>
<span class="s3">}</span>
</pre>
</body>
